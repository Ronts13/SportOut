...
import app.models.sport_profile  # noqa: F401
...
# DATABASE_URL env var wins over alembic.ini — keeps secrets out of the ini file
...
def run_migrations_offline() -> None:
    """Render SQL to stdout without a live DB connection (alembic upgrade head --sql)."""
